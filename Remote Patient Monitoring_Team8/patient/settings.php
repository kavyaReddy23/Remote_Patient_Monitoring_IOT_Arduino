            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td>
                                    <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">View Account Details</p><br><br>
                                </td>
                            </tr>
                            ...
                            <tr>
                            <td class="label-td" colspan="2">
                                <label for="spec" class="form-label">Room Temperature: </label>
                            ...
                            <tr>
                            <td class="label-td" colspan="2">
                                <label for="spec" class="form-label">Humidity: </label>
                            ...
                            <tr>
                            <td class="label-td" colspan="2">
                                <label for="spec" class="form-label">Body Temperature: </label>
                            ...
                            <td class="label-td" colspan="2">
                                <label for="spec" class="form-label">Spo2: </label>
                            ...
                            <tr>
                            <td class="label-td" colspan="2">
                                <label for="spec" class="form-label">BPM: </label>
